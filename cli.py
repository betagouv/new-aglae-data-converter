...
import logging
import h5py
from lst.parser import LstParser, LstParserConfigOutlets

logger = logging.getLogger(__name__)


def convert_lst_to_hdf5(data_path: pathlib.Path, output_path: pathlib.Path):
    """
    ...
    parser = LstParser(filename=data_path, config=LstParserConfigOutlets())
...
if __name__ == "__main__":
    ...
    convert_lst_to_hdf5(args.data_path, args.output_path)
